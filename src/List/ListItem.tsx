...
export interface ListItemProps extends PropsWithHTMLAttr<HTMLLIElement> {
  /**
   * Parent List component id.
   * This prop is automatically generated by List component.
   */
  listId?: string;
  children: React.ReactNode;
}

export function ListItem({ listId, children, ...restProps }: ListItemProps): JSX.Element {
  ...
  return (
    <Li ref={containerRef} onFocus={handleFocus} onBlur={handleBlur} tabIndex={0} data-list-id={listId} {...restProps}>
      {children}
    </Li>
  );
}
